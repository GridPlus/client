// Setup functions for initializing, opening payment channels
package setup
...
func Init() ([]string){
  ...
  return []string{auth_token, conf.WalletAddr, conf.HashedSerialNo, bolt_addr, conf.API, conf.WalletPkey}
}
